    ...
    <div class='container'>
        ...
        <div id="loginform">
            ...
            <form method="POST"> <!-- Front end bit to get login deets -->
                <input value="<?=set_value('username')?>" class='inputsignin' type="text" name="username" placeholder="Admin name"><br/>
                <div class="errors"><?=$data['errors']['username'];?></div></br><br/>
                <input value="<?=set_value('password')?>" class='inputsignin' type="password" name="password" placeholder="Admin password"><br/>
                <div class="errors"><?=$data['errors']['password'];?></div><br/><br/>
                <div id="buttoncontainer">
                    <button type="reset" class="secondarybutton">Reset</button>
                    <button type="submit" name="login" class="primarybutton">Login</button>
                </div>
                <div>
                    Don't have an account? <a class="signuplink" href="signup">Sign up</a>
                </div>
            </form>
        </div> 
    </div>
