...
<head>
    ...
    <!-- <link href="<?= ROOT ?>/assets/css/adminstyles.css" rel="stylesheet"> -->
    ...
    <div class='container'>
        ...
        <div id="loginform">
            ...
            <form method="POST"> <!-- Front end bit to get login deets -->
                ...
                <input value="<?= set_value('station_id') ?>" class='inputsignin' type="text" name="station_id" placeholder="station_id">
                <?php if (isset($data['errors']['station_id'])) : ?>
                    <p class="error"><?php echo $data['errors']['station_id']; ?></p>
                <?php endif; ?>
                <br>


                <input value="<?= set_value('password') ?>" class='inputsignin' type="password" name="password" placeholder="Admin password">
                <?php if (isset($data['errors']['password'])) : ?>
                    <p class="error"><?php echo $data['errors']['password']; ?></p>
                <?php endif; ?>


                <?php if (isset($data['errors']['auth'])) : ?>
                    <p class="error"><?php echo $data['errors']['auth']; ?></p>
                <?php endif; ?>
                ...
                <div>
                    Don't have an account? <a href="station_signup">Sign up</a>
                </div>
