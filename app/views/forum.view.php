...
<head>
    ...
    <link href = "../public/assets/css/formstyles.css" rel = "stylesheet">
    <style>
        #forum{
            color:#E14761;
        }
        ...
        <div class='posts'>
            ...
            if (!empty($data['posts'])) {
                foreach ($data['posts'] as $post) {
                    ...
                    $post['timestamp'] = $dateTime->format('Y-m-d H:i');?>
                <a href='postdetails?id=<?=$post["postID"]?>' class='card'>
                        ...
                        <div class='authortime'><small><?php
                            if($post["admin"]){
    ...
    <div id='floatform' class='new-forum-form'>
        <div class="form-content">
            ...
            <form class='forum-form' method="POST">
                ...
                <input type="text" name="title" placeholder="Title" class='inputs3' required>
                <br/>
                <label for="content">Content</label>
                <textarea name="content" class='input-area' placeholder="Content" required></textarea>
                <br/>
                <!-- if the user type is admin in the url, show radio buttons eith values: post or announcement to choose from -->
                <?php if($_SESSION['type'] == 'admin'):?>
                    <span class='radio'>
                        <input type="checkbox" name="type" value="announce"> Post as an Announcement
                    </span>
                <?php endif;?>
                <br/><br/>
