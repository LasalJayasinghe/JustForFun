...
<body>
    ...
    <div class="profile-card">
      ...
      <div class="form-container">
        ...
        <form method="post">
          ...
          <label for="fname">BRN :</label>
          <input value="<?= $row['brn'] ?>" class='inputsignin' type="text" name="brn" id="brn" placeholder="Business Registration Number" readonly>
          <br>

          <label for="fname">Company Name:</label>
          <input value="<?= $row['companyname'] ?>" class='inputsignin' type="text" name="companyname" id="companyname" placeholder="Company Name" readonly>
          ...
          <input value="<?= $row['mobileno'] ?>" class='inputsignin' type="text" name="mobileno" id="mobileno" placeholder="Mobile No" required>
  ...
  <div id='changepassword' class='Change-new'>
    <div class="Change-content">
      ...
      <?php if (!empty($row)) : ?>
        <form id="form" method="POST" action="<?= ROOT ?>/stationadmin/profilepasswordupdate/<?= $row['id'] ?>">
          <label for="oldPassword">Old Password</label><br>
          <input type="password" id="oldPassword" name="oldPassword" placeholder="Old Password" required1><br>
          <?php if (!empty($errors['oldPassword'])) : ?>
            <div class="error"><?= $errors['oldPassword'] ?></div>
          <?php endif; ?>

          <label for="password">New Password</label><br>
          <input value="<?= set_value('password') ?>" type="text" id="password" name="password" placeholder="New Password" required1><br>
          <?php if (!empty($errors['password'])) : ?>
            <div class="error"><?= $errors['password'] ?></div>
          <?php endif; ?>

          <label for="c_np">New Password Again</label><br>
          <input type="password" id="c_np" name="c_np" placeholder="New Password Again" required1><br>
